...
class L10n {
  ...
  static const Map<String, List<String>> _m = {
    ...
    'select_member': ['Select a member', 'Wybierz domownika', 'Виберіть члена сім\'ї'],
    'assign_someone_first': ['Pick who this task is for.', 'Wybierz, kto wykonuje zadanie.', 'Виберіть, хто виконує завдання.'],
    ...
    'task_saved': ['Task saved', 'Zadanie zapisane', 'Завдання збережено'],
    'modal_edit_task': ['Edit task', 'Edytuj zadanie', 'Редагувати завдання'],
    'modal_task_save_btn': ['Save changes', 'Zapisz zmiany', 'Зберегти зміни'],
    'task_acceptance': ['approval', 'akceptacja', 'підтвердження'],
    'task_pending_approval': ['awaiting approval', 'czeka na zatwierdzenie', 'очікує підтвердження'],
    'task_one_time_sched': ['One-time', 'Jednorazowo', 'Одноразово'],
    ...
    'room_stat_today': ['TODAY', 'DZIŚ', 'СЬОГОДНІ'],
    'room_stat_week': ['7 DAYS', '7 DNI', '7 ДНІВ'],
    'room_stat_points': ['POINTS', 'PUNKTY', 'БАЛИ'],
    'room_tasks_label': ['Tasks', 'Zadania', 'Завдання'],
    ...
    'cal_free_day': ['Nothing scheduled', 'Nic nie zaplanowano', 'Нічого не заплановано'],
    'cal_delete_recurring_q': ['Delete recurring task?', 'Usunąć powtarzające się zadanie?', 'Видалити повторюване завдання?'],
    'cal_skip_occurrence': ['Only this occurrence', 'Tylko to wystąpienie', 'Лише цей раз'],
    'cal_delete_all_future': ['All future occurrences', 'Wszystkie kolejne', 'Усі наступні'],
    ...
    'to_approve': ['To approve', 'Do zatwierdzenia', 'До підтвердження'],
    'to_do': ['To do', 'Do wykonania', 'Зробити'],
    'goals_fulfilled_section': ['Fulfilled', 'Zrealizowane', 'Виконані'],
    'buy_for_q': ['Buy for', 'Kupić za', 'Купити за'],
    'remaining_colon': ['Remaining:', 'Pozostanie:', 'Залишиться:'],
    'owner_notified': [
      '🔔 The owner will be notified and must fulfill it in real life!',
      '🔔 Właściciel zostanie powiadomiony i musi to zrealizować w prawdziwym życiu!',
      '🔔 Власник отримає сповіщення і повинен виконати це в реальному житті!'
    ],
    'buy_btn': ['🎯 Buy!', '🎯 Kup!', '🎯 Купити!'],
    ...
    'enter_email_pass': ['Enter an email and password.', 'Podaj email i hasło.', 'Введіть email та пароль.'],
    ...
    'verify_email_title': ['Confirm your email', 'Potwierdź adres email', 'Підтвердіть email'],
    'verify_email_desc': ['We sent a code to {email}', 'Wysłaliśmy kod na {email}', 'Ми надіслали код на {email}'],
    'verify_confirm': ['Confirm', 'Potwierdź', 'Підтвердити'],
    'resend_code': ['Resend code', 'Wyślij kod ponownie', 'Надіслати код ще раз'],
    'code_resent': ['New code sent.', 'Wysłano nowy kod.', 'Надіслано новий код.'],
    'or': ['or', 'lub', 'або'],
    'continue_with_google': ['Continue with Google', 'Kontynuuj z Google', 'Продовжити з Google'],
    'google_setup_title': ['Almost done', 'Prawie gotowe', 'Майже готово'],
    'join_cleanhabit': ['Join CleanHabit', 'Dołącz do CleanHabit', 'Приєднатися до CleanHabit'],
    'enter_code6_digits': ['Enter the 6-digit code.', 'Wpisz 6-cyfrowy kod.', 'Введіть 6-значний код.'],
